...
typedef enum {
	...
	ARDRONE_COMMAND_CAMERA_DETECTION,	// Command to set camera type for detection. 
	ARDRONE_COMMAND_ENEMY_SET_PARAM,	// Command to set enemy parameter for detection (color and hull).
	ARDRONE_COMMAND_ENABLE_COMBINED_YAW,// Command to enable / disable combined yaw command. 
	ARDRONE_COMMAND_SET_FLY_MODE,		// Command to change flying mode
} ARDRONE_COMMAND_IN;
